...
| 圖片生成 | 提取提示詞 |
| --- | --- |
| <img src="./pics/generate.png" alt="圖片生成" /> | <img src="./pics/extract-prompt.png" alt="提取提示詞" /> |

| API 管理 | 專案管理 |
| --- | --- |
| <img src="./pics/api-management.png" alt="API 管理" /> | <img src="./pics/project-management.png" alt="專案管理" /> |
