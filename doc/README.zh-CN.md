...
| 图片生成 | 提取提示词 |
| --- | --- |
| <img src="./pics/generate.png" alt="图片生成" /> | <img src="./pics/extract-prompt.png" alt="提取提示词" /> |

| API 管理 | 项目管理 |
| --- | --- |
| <img src="./pics/api-management.png" alt="API 管理" /> | <img src="./pics/project-management.png" alt="项目管理" /> |
